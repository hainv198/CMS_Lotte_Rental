...
Route::group(['prefix' => '/about'],function() {
    ...
    Route::get('/structure' , 'AboutController@structure')->name('structure');
...
Route::group(['prefix' => '/mobile'],function() {
    Route::get('/', 'MobileController@index') ->name('mb-home');
    Route::get('overview', 'MobileController@AboutMobile') ->name('overview-mb');
    Route::get('history', 'MobileController@HistoryMobile') ->name('history-mb');
    Route::get('structure', 'MobileController@StructureMobile') ->name('structure-mb');
    Route::get('network', 'MobileController@NetworkMobile') ->name('network-mb');
    Route::get('rental-car', 'MobileController@ServicesMobile') ->name('rental-car');
    Route::get('equipment', 'MobileController@EquipmentMobile') ->name('equipment-mb');
    Route::get('sales', 'MobileController@BuySellMobile') ->name('sales-mb');
    Route::get('pr-center', 'MobileController@PRCenterMobile') ->name('pr-center-mb');
    Route::get('customer-center', 'MobileController@CustomerCenterMobile') ->name('customer-center-mb');
    Route::get('career', 'MobileController@CareerMobile') ->name('career');
});

/*==// Upload Image //==*/
Route::resource('news', 'WebControllers@NewsController');
