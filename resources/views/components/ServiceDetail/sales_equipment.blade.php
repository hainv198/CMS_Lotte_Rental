                        ...
                        <div id="top-functions-area" class="top-functions-area" >
                            <div class="flt-item to-left group-on-mobile">
                                ...
                                <div class="wrap-selectors">
                                    <form action="{{route('sales-equipment')}}" name="frm-refine" method="get">
                                        ...
                                        <div data-title="Hãng xe:" class="selector-item">
                                            <select name="car_base" class="selector">
                                                ...
                                                @foreach($sales_equipment as $item)
                                                ...
                                                <div class="contain-product pr-detail-layout">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <ul  class="text-left list-detail-info-car">
                                                            ...
                                                            <li>
                                                                <span><i class='bx bx-category-alt'></i> {{$item->car_base}}</span>
                                                            </li>
                                                            <li>
                                                                <span><i class='bx bx-user' ></i> {{$item->country}}</span>
                                                                <span><i class='bx bx-timer'></i> {{$item->year}} tháng</span>
                                                            </li>
                                                            <li>
                                                    <span>
